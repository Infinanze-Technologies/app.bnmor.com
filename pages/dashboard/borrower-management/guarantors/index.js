...
// View Components
import Guarantor from "@/modules/views/Admin/ManBorrower/Guarantor/index"
 ...
 */
const GuarantorsPageWithLayout = ({ 
  props, 
...
/**
 * Content component that shows the Guarantor component for users with User.create permission
 */
const GuarantorsPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
  ...
  const hasUserCreatePermission = hasAnyOfPermissions(permissions, PERMISSIONS.GUARANTOR_CREATE);
...
/**
 * GuarantorsPage - Guarantors management page
 * Handles security checks for User.create permission
 */
export default function GuarantorsPage(props) {
  // =============================================================================
