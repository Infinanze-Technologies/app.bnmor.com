...
// View Components
import Borrower from "@/modules/views/Admin/ManBorrower/Borrower/index"
...
/**
 * Content component that shows the Borrower component for users with User.create permission
 */
const BorrowersPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
  ...
  const hasUserCreatePermission = hasAnyOfPermissions(permissions, PERMISSIONS.BORROWER_CREATE);
...
/**
 * BorrowersPage - Borrowers management page
 * Handles security checks for User.create permission
 */
export default function BorrowersPage(props) {
  // =============================================================================
