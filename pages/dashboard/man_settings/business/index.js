...
// View Components
import BusinessSettings from "@/modules/views/Admin/ManSettings/Business/index"
 ...
 */
const BusinessSettingsPageWithSidebar = ({ 
  props, 
 ...
 */
const BusinessSettingsPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Business Settings Page" />
      <BusinessSettingsPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the BusinessSettings component for users with User.create permission
 */
const BusinessSettingsPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
  ...
  const hasUserCreatePermission = hasAnyOfPermissions(permissions, PERMISSIONS.BRANCH_UPDATE);
...
/**
 * BusinessSettingsPage - Business settings page
  ...
  return (
    <>
      ...
      {typeof (props?.jwt) === "undefined" ? (
        ...
        >
          <BusinessSettingsPageWithLayout 
            props={props}
          />
        </SecurityGuard>
      )}
