...
// View Components
import Designation from "@/modules/views/Admin/ManSettings/Designation/index"
 ...
 */
const DesignationPageWithSidebar = ({ 
  props, 
 ...
 */
const DesignationPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Designation Page" />
      <DesignationPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the Designation component for users with User.create permission
 */
...
/**
 * DesignationPage - Designation management page
 * Handles security checks for User.create permission
 */
export default function DesignationPage(props) {
  // =============================================================================
