...
// View Components
import AwardType from "@/modules/views/Admin/ManSettings/AwardType/index"
 ...
 */
const AwardTypePageWithSidebar = ({ 
  props, 
...
const AwardTypePageWithLayout = ({ 
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Award Type" />
      <AwardTypePageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the AwardType component for users with User.create permission
 */
const AwardTypePageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * AwardTypePage - Award type management page
 * Handles security checks for User.create permission
 */
export default function AwardTypePage(props) {
  // =============================================================================
