...
// View Components
import LeaveType from "@/modules/views/Admin/ManSettings/LeaveType/index"
 ...
 */
const LeaveTypePageWithSidebar = ({ 
  props, 
...
const LeaveTypePageWithLayout = ({ 
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Leave Type" />
      <LeaveTypePageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the LeaveType component for users with User.create permission
 */
const LeaveTypePageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * LeaveTypePage - Leave type management page
 * Handles security checks for User.create permission
 */
export default function LeaveTypePage(props) {
  // =============================================================================
