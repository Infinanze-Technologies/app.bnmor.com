...
// View Components
import PaymentType from "@/modules/views/Admin/ManSettings/PaymentType/index"
 ...
 */
const PaymentTypePageWithSidebar = ({ 
  props, 
 ...
 */
const PaymentTypePageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
...
/**
 * Content component that shows the PaymentType component for users with User.create permission
 */
const PaymentTypePageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * PaymentTypePage - Payment type management page
