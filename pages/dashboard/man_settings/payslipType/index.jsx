...
// View Components
import PayslipType from "@/modules/views/Admin/ManSettings/PayslipType/index"
 ...
 */
const PayslipTypePageWithSidebar = ({ 
  props, 
 ...
 */
const PayslipTypePageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Payslip Type" />
      <PayslipTypePageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the PayslipType component for users with User.create permission
 */
const PayslipTypePageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * PayslipTypePage - Payslip type management page
 * Handles security checks for User.create permission
 */
export default function PayslipTypePage(props) {
  // =============================================================================
