...
// View Components
import Department from "@/modules/views/Admin/ManSettings/Department/index"
 ...
 */
const DepartmentPageWithSidebar = ({ 
  props, 
 ...
 */
const DepartmentPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Department Page" />
      <DepartmentPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the Department component for users with User.create permission
 */
...
/**
 * DepartmentPage - Department management page
