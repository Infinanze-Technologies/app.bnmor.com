...
// View Components
import IncomeType from "@/modules/views/Admin/ManSettings/IncomeType/index"
 ...
 */
const IncomeTypePageWithSidebar = ({ 
  props, 
 ...
 */
const IncomeTypePageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Income Type" />
      <IncomeTypePageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the IncomeType component for users with User.create permission
 */
const IncomeTypePageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * IncomeTypePage - Income type management page
 * Handles security checks for User.create permission
 */
export default function IncomeTypePage(props) {
  // =============================================================================
