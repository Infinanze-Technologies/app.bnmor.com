...
// View Components
import DeductionOption from "@/modules/views/Admin/ManSettings/DeductionOption/index"
 ...
 */
const DeductionOptionPageWithSidebar = ({ 
  props, 
 ...
 */
const DeductionOptionPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Deduction Option" />
      <DeductionOptionPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the DeductionOption component for users with User.create permission
 */
const DeductionOptionPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * DeductionOptionPage - Deduction option management page
 * Handles security checks for User.create permission
 */
export default function DeductionOptionPage(props) {
  // =============================================================================
