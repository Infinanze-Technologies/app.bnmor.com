...
// View Components
import AccountList from "@/modules/views/Admin/Finance/AccountList/index"
 ...
 */
const AccountListPageWithSidebar = ({ 
  props, 
 ...
 */
const AccountListPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
...
/**
 * Content component that shows the AccountList component for users with User.create permission
 */
const AccountListPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * AccountListPage - Account list management page
