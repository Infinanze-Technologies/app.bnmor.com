...
// View Components
import AccountBalance from "@/modules/views/Admin/Finance/AccountBalance/index"
 ...
 */
const AccountBalancePageWithSidebar = ({ 
  props, 
 ...
 */
const AccountBalancePageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Account Balance Page" />
      <AccountBalancePageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the AccountBalance component for users with User.create permission
 */
const AccountBalancePageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * AccountBalancePage - Account balance management page
 * Handles security checks for User.create permission
 */
export default function AccountBalancePage(props) {
  // =============================================================================
