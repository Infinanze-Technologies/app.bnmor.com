...
// View Components
import Payee from "@/modules/views/Admin/Finance/Payees/index"
...
/**
 * Content component that shows the Payee component for users with User.create permission
 */
const PayeePageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * PayeePage - Payee management page
 * Handles security checks for User.create permission
 */
export default function PayeePage(props) {
  // =============================================================================
