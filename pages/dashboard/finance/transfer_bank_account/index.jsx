...
// View Components
import BankTransfer from "@/modules/views/Admin/Finance/BankTransfer/index"
 ...
 */
const BankTransferPageWithSidebar = ({ 
  props, 
 ...
 */
const BankTransferPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="BankTransfer Page" />
      <BankTransferPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the BankTransfer component for users with User.create permission
 */
const BankTransferPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * BankTransferPage - Bank transfer management page
 * Handles security checks for User.create permission
 */
export default function BankTransferPage(props) {
  // =============================================================================
