...
// View Components
import Expenses from "@/modules/views/Admin/Finance/Expenses/index"
...
const ExpensesPageWithLayout = ({ 
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Expenses Page" />
      <ExpensesPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the Expenses component for users with User.create permission
 */
...
/**
 * ExpensesPage - Expenses management page
