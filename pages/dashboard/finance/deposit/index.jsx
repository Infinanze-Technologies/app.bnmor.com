...
// View Components
import Deposit from "@/modules/views/Admin/Finance/Deposit/index"
...
const DepositPageWithLayout = ({ 
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Deposit Page" />
      <DepositPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the Deposit component for users with User.create permission
 */
...
/**
 * DepositPage - Deposit management page
