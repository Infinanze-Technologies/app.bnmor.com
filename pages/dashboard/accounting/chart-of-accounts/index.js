...
// View Components
import COA from "@/modules/views/Admin/COA/index"
 ...
 */
const ChartOfAccountsPageWithSidebar = ({ 
  props,
 ...
 */
const ChartOfAccountsPageWithLayout = ({ 
  props,
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    ...
    >
      ...
      <ChartOfAccountsPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the COA component for users with User.create permission
 */
const ChartOfAccountsPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
  ...
  const hasUserCreatePermission = hasAnyOfPermissions(permissions, PERMISSIONS.FINANCE_CREATE);
...
/**
 * ChartOfAccountsPage - Chart of accounts management page
