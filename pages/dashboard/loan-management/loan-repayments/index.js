...
// Dynamic import for LoanRepayments component
const LoanRepayments = dynamic(
  () => import('@/modules/views/Admin/ManLoan/Repayments/index'),
 ...
 */
const LoanRepaymentsPageWithSidebar = ({ 
  props, 
 ...
 */
const LoanRepaymentsPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
...
/**
 * Content component that shows the LoanRepayments component for users with User.create permission
 */
const LoanRepaymentsPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * LoanRepaymentsPage - Loan repayments management page
 * Handles security checks for User.create permission
 */
export default function LoanRepaymentsPage(props) {
  // =============================================================================
