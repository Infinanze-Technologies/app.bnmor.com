...
const EditLoanProduct = dynamic(
    () => import('@/modules/views/Admin/ManLoan/LoanProducts/conponents/EditLoanProduct'),
 ...
 */
const EditLoanProductPageWithLayout = ({ 
  props,
  decoded,
  role_permz
}) => {
  return (
    ...
    >
      <PageTitle title="Edit Loan Product" />
        ...
        <>
          {typeof(role_permz) != "undefined"
           && role_permz.includes("User.create")
             ?
             ( 
              <EditLoanProduct session={props}  permissions={decoded} />
             )
             :(
               <>
...
export default function EditLoanProductPage(props) {
