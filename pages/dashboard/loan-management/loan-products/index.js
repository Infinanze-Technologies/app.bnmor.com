...
// Dynamic import for LoanProducts component
const LoanProducts = dynamic(
  () => import('@/modules/views/Admin/ManLoan/LoanProducts/index'),
 ...
 */
const LoanProductsPageWithSidebar = ({ 
  props, 
 ...
 */
const LoanProductsPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
...
/**
 * Content component that shows the LoanProducts component for users with User.create permission
 */
const LoanProductsPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * LoanProductsPage - Loan products management page
 * Handles security checks for User.create permission
 */
export default function LoanProductsPage(props) {
  // =============================================================================
