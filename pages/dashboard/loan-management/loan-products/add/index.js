...
// Dynamic import for AddLoanProduct component
const AddLoanProduct = dynamic(
  () => import('@/modules/views/Admin/ManLoan/LoanProducts/conponents/AddLoanProduct'),
 ...
 */
const AddLoanProductPageWithSidebar = ({ 
  props, 
 ...
 */
const AddLoanProductPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Add Loan Product" />
      <AddLoanProductPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
/**
 * Content component that shows the AddLoanProduct component for users with User.create permission
 */
const AddLoanProductPageContent = ({ 
  props, 
  role_name,
  role_status,
  role_is_super,
...
/**
 * AddLoanProductPage - Add loan product page
 * Handles security checks for User.create permission
 */
export default function AddLoanProductPage(props) {
  // =============================================================================
