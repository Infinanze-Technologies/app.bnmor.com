...
// View Components
import Resignation from "@/modules/views/Admin/Hr/resignation"
import EmpResignation from "@/modules/views/Staffs/Hr/resignation"
 ...
 */
const ResignationPageWithSidebar = ({ 
  props, 
 ...
 */
const ResignationPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Resignation Page" />
      <ResignationPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
const ResignationPageContent = ({ 
  ...
  // Permission checks
  const hasUserCreatePermission = hasAnyOfPermissions(permissions, PERMISSIONS.RESIGNATION_CREATE);
...
/**
 * ResignationPage - Resignation management page
 * Handles data fetching and security checks
 */
export default function ResignationPage(props) {
  // =============================================================================
