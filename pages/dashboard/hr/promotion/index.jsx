...
// View Components
import Promotion from "@/modules/views/Admin/Hr/promotion/index"
import EmpPromotion from "@/modules/views/Staffs/Hr/promotion/index"
 ...
 */
const PromotionPageWithSidebar = ({ 
  props, 
...
const PromotionPageWithLayout = ({ 
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Promotion Page" />
      <PromotionPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
const PromotionPageContent = ({ 
  ...
  // Permission checks
  const hasUserCreatePermission = hasAnyOfPermissions(permissions, PERMISSIONS.PROMOTION_CREATE);
...
/**
 * PromotionPage - Promotion management page
