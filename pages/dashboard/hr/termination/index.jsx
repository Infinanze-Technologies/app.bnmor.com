...
// View Components
import Termination from "@/modules/views/Admin/Hr/termination/index"
import EmpTermination from "@/modules/views/Staffs/Hr/termination/index"
 ...
 */
const TerminationPageWithSidebar = ({ 
  props, 
 ...
 */
const TerminationPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
  ...
  return (
    <AppLayout
      ...
      role_is_super={role_is_super}
    >
      <PageTitle title="Termination Page" />
      <TerminationPageWithSidebar 
        props={props}
        role_name={role_name}
        role_status={role_status}
        role_is_super={role_is_super}
...
const TerminationPageContent = ({ 
  ...
  // Permission checks
  const hasUserCreatePermission = hasAnyOfPermissions(permissions, PERMISSIONS.TERMINATION_CREATE);
...
/**
 * TerminationPage - Termination management page
 * Handles data fetching and security checks
 */
export default function TerminationPage(props) {
  // =============================================================================
