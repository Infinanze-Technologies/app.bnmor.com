...
// View Components
import EmpSetSalary from "@/modules/views/Staffs/Payroll/SetSalary/conponents/SetSalary"
...
/**
 * Content component that shows the EmpSetSalary component for Staff users
 */
const SetSalaryPageContent = ({ 
  ...
  return (
    <EmpSetSalary 
      ...
      SingleEmployeeData={SingleEmployeeData} 
      SingleEmployeeDocumentData={SingleEmployeeDocumentData} 
      employee_id={props?.user?.user_id} 
      permissions={permissions}
      role_name={role_name}
      role_status={role_status}
      role_is_super={role_is_super}
...
/**
 * SetSalaryPage - Set salary page for staff
