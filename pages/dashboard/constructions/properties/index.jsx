...
// View Components
import Properties from "@/modules/views/Admin/Construction/Properties/index"
 ...
 */
  const PropertiesPageWithSidebar = ({ 
  props, 
 ...
 */
const PropertiesPageWithLayout = ({ 
  props, 
  // Role information automatically passed from SecurityGuard
  role_name,
  role_status,
...
/**
 * Content component that shows the Properties component for users with User.create permission
 */
const PropertiesPageContent = ({ 
  ...
  const hasUserCreatePermission = hasAnyOfPermissions(permissions, PERMISSIONS.CONSTRUCTION_CREATE);
...
/**
 * PropertiesPage - Properties management page
 * Handles security checks for Properties.create permission
 */
