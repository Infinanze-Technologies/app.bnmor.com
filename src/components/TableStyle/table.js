...
const TableWrapper = Styled.div`
    ...
    .ant-table table{
        ...
        border-radius: 0;
        overflow: hidden;
        box-shadow: 0 12px 40px rgba(95, 99, 242, 0.12);
        border: 1px solid rgba(95, 99, 242, 0.15);
        background: #ffffff;
    }
    .ant-table-thead > tr > th{
        text-align: ${({ theme }) => (!theme.rtl ? 'left' : 'right')};
        background: linear-gradient(135deg, #5F63F2 0%, #4347D9 100%) !important;
    ...
    .ant-table-tbody > tr {
        ...
        border-bottom: 1px solid rgba(95, 99, 242, 0.05);
        
        &:hover {
            background: linear-gradient(135deg, rgba(95, 99, 242, 0.03) 0%, rgba(67, 71, 217, 0.05) 100%) !important;
            transform: translateY(-1px);
            box-shadow: 0 4px 12px rgba(95, 99, 242, 0.1);
        }
    ...
    &.table-data-view{
        ...
        tbody{
            tr{
                &:hover{
                    td{
                        background: linear-gradient(135deg, rgba(95, 99, 242, 0.05) 0%, rgba(67, 71, 217, 0.08) 100%) !important;
                    }
                }
                td{
                    .product-id{
                ...
                td{
                    ...
                    .record-img{
                        img{
                            ...
                            margin-right: 12px;
                            min-height: 42px;
                            border: 2px solid rgba(95, 99, 242, 0.1);
                            transition: all 0.3s ease;
                    ...
                    .status{
                        ...
                        &.deactivated{
                            color: #ffc107;
                            background: linear-gradient(135deg, rgba(255, 193, 7, 0.1) 0%, rgba(253, 126, 20, 0.15) 100%);
                            border: 1px solid rgba(255, 193, 7, 0.2);
                        }
                        &.blocked{
                            color: #dc3545;
                            background: linear-gradient(135deg, rgba(220, 53, 69, 0.1) 0%, rgba(231, 76, 60, 0.15) 100%);
            ...
            tr{
                ...
                th{
                    ...
                    &::after {
                        ...
                        right: 0;
                        height: 2px;
                        background: linear-gradient(90deg, transparent, rgba(95, 99, 242, 0.3), transparent);
                    }
                }
            }
        }
        tbody{
            tr{
                ...
                &.ant-table-row-selected{
                    &:hover{
                        td{
                            background: linear-gradient(135deg, rgba(95, 99, 242, 0.08) 0%, rgba(67, 71, 217, 0.12) 100%) !important;
                        }
                    }
                    td{
                        background: linear-gradient(135deg, rgba(95, 99, 242, 0.05) 0%, rgba(67, 71, 217, 0.08) 100%) !important;
