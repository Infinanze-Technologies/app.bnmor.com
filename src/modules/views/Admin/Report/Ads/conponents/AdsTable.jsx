...
import { URL_RE_SEND_EMAIL_LINK,URL_DELETE_CUSTOMER } from "@/config/api-paths";
...
const AdsTable = (props) => {
  ...
  const handleDelete = (record) => {
    deleteRequest(URL_DELETE_CUSTOMER, record?.id, jwt)
      .then((res) => {
