...
const FilterOptions = (props) => {
  ...
  const statusOptions = [
    ...
    { value: 'CONFIRMED', label: 'Confirmed', color: '#52c41a' },
    { value: 'FAILED', label: 'Failed', color: '#ff4d4f' },
    { value: 'REFUNDED', label: 'Refunded', color: '#1890ff' },
    { value: 'REVERSED', label: 'Reversed', color: '#000000' }
  ];
  ...
  const applyFilters = () => {
    ...
    if (loanId) {
      apiFilter += `loan_id=${encodeURIComponent(loanId)}&`;
    }
  ...
  return (
    <>
      ...
      />
        ...
        {(searchText || loanId || selectedStatus !== 'ALL' || selectedDateRange !== 'ALL') && (
          <div style={{ 
            marginTop: '24px', 
            padding: '16px',
      ...
      >
        <div style={{ marginBottom: '20px' }}>
          <p style={{ color: '#4D4D4D', marginBottom: '16px', fontWeight: '500' }}>
            Choose your custom date range for filtering repayments
          </p>
