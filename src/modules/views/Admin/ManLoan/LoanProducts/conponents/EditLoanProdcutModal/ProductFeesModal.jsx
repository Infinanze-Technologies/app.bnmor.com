...
import { URL_UPDATE_LOAN_PRODUCT_FEES_DETAILS } from "@/config/api-paths";
import useHandleResponse from "@/hooks/useHandleResponse";
import { BUTTON_CONFIGS } from "@/utils/buttonStyles";
const { Option } = Select;

const ProductFeesModal = (props) => {
  let jwt = props?.jwt;
  ...
  const onFinish = async values => {
    ...
    try {
      ...
      await updateRequest(URL_UPDATE_LOAN_PRODUCT_FEES_DETAILS,record.product_id, {...data}, jwt)
      .then((res) => {
  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: 24 }}>
      <Card
        title={<span style={{ fontSize: 20, fontWeight: 700, color: "#2a3f54" }}>Edit Product Fees</span>}
        bordered={false}
...
export default ProductFeesModal;
