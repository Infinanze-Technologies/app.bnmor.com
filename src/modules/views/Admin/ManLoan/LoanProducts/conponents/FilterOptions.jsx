...
const FilterOptions = ({ setfilterUserData, setSearch, setFilters }) => {
  ...
  const statusOptions = [
    ...
    { value: 'true', label: 'Active', color: '#52c41a' },
    { value: 'false', label: 'Inactive', color: '#faad14' }
  ];
  ...
  const applyFilters = () => {
    ...
    if (selectedStatus !== 'ALL') {
      apiFilter += `is_active=${selectedStatus}&`;
    }
  ...
  return (
    <>
      ...
      />
        ...
        {(searchText || selectedStatus !== 'ALL' || selectedInterestMethod !== 'ALL' || selectedDateRange !== 'ALL') && (
          <div style={{ 
            marginTop: '24px', 
            padding: '16px',
      ...
      >
        <div style={{ marginBottom: '20px' }}>
          <p style={{ color: '#4D4D4D', marginBottom: '16px', fontWeight: '500' }}>
            Choose your custom date range for filtering loan products
          </p>
