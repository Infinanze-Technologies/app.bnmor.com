...
const FilterOptions = (props) => {
  const { setfilterUserData, QryBranchDataObject, ActiveVisitorsDataObject, DepartmentsDataObject, HostsDataObject } = props;
  ...
  return (
    <>
      ...
      />
        ...
        {(searchText || selectedGuest !== 'ALL' || selectedHost !== 'ALL' || selectedDepartment !== 'ALL' || selectedVisitType !== 'ALL' || selectedStatus !== 'ALL' || selectedDateRange !== 'ALL') && (
          <div style={{ 
            marginTop: '24px', 
            padding: '16px',
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              ...
              {selectedHost !== 'ALL' && (
                ...
                >
                  🏢 Host: {hostOptions.find(h => h.value === selectedHost)?.label}
                </Tag>
              )}
      ...
      >
        <div style={{ marginBottom: '20px' }}>
          <p style={{ color: '#4D4D4D', marginBottom: '16px', fontWeight: '500' }}>
            Choose your custom date range for filtering appointments
          </p>
