...
import { URL_ADD_VISITOR_ENTRIES } from "@/config/api-paths";
...
const AddEntry = (props) => {
  ...
  let { QryBranchDataObject, GuestsDataObject, HostsDataObject, DepartmentsDataObject, jwt, setIsModalVisible, refetch, setpage, forceRefetch } = props;
  ...
  return (
    <div style={{ 
      ...
      <Card
        title={<span style={{ fontSize: 24, fontWeight: 700, color: "#2a3f54" }}>Create New Entry</span>}
        bordered={false}
