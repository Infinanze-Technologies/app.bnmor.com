...
const FilterOptions = (props) => {
  const { setfilterUserData, DepartmentsDataObject, ActiveDesignationDataObject } = props;
  ...
  return (
    <>
      ...
      />
        ...
        {(searchText || selectedDepartment !== 'ALL' || selectedDesignation !== 'ALL' || selectedDateRange !== 'ALL') && (
          <div style={{ 
            marginTop: '24px', 
            padding: '16px',
