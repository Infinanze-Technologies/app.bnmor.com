...
const StaffTable = (props) => {
  ...
  const [statusUpdateRecord, setStatusUpdateRecord] = useState(null);
  ...
  const menu = (record) => (
    ...
    >
      ...
      >
        <a onClick={() => handleView(record)} style={{ color: '#4D4D4D' }}>View</a>
      </Menu.Item>
...
// console.log('====================================');
  ...
  return (
    <>
            ...
            <UserTableStyleWrapper>
              <TableWrapper style={{
                ...
                <Table
                  ...
                  locale={{
                    emptyText: qry_data?.length === 0 ? 'No staff data found' : 'No data'
                  }}
                  rowKey="id"
                  style={{
                    background: '#ffffff'
      ...
      <StatusUpdateModal
        isVisible={statusUpdateModalVisible}
