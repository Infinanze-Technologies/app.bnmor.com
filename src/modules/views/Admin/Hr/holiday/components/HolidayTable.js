...
import {URL_BRANCH_STATUS,URL_DELETE_BRANCH, URL_DELETE_DEPARTMENT, URL_DELETE_HOLIDAY, URL_DELETE_LEAVE, URL_DELETE_TIMESHEET } from "@/config/api-paths";
...
const LeaveTable = (props) => {
  ...
  let {  jwt,HolidayDataObject,QryEmployeeDataObject,AttributesDataObject } = props;
...
// console.log('====================================');
  ...
  let qryData = HolidayDataObject?.data || []
  ...
  }, [HolidayDataObject,qryEmployeeData]);
  ...
  const showModal = (value, record) => {
    ...
    if (value == "add") {
      ...
      setModalWidth(500);
      setModalContent(<AddHoliday setIsModalVisible={setIsModalVisible} jwt={jwt} refetch={refetch} forceRefetch={forceRefetch} qryEmployeeData={qryEmployeeData} qryAttrData={qryAttrData}/>)
      }
  ...
  const EditHolidayStatusTitle = () => (
    <div className="flex flex-wrap" style={{ width: 700 }}>
      <h6>Edit Holiday Status</h6>
    </div>
  );


  const EditHolidayTitle = () => (
    <div className="flex flex-wrap" style={{ width: 700 }}>
      <h6>Edit Holiday</h6>
    </div>
  );

  const AddHolidayTitle = () => (
    <div className="flex flex-wrap" style={{ width: 700}}>
    <h6>Add Holiday</h6>
  ...
  const handleDelete = (record) => {
    deleteRequest(URL_DELETE_HOLIDAY, record?.holiday_id, jwt)
      .then(async(res) => {
