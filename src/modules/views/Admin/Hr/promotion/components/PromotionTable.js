...
import {URL_BRANCH_STATUS,URL_DELETE_AWARD,URL_DELETE_BRANCH, URL_DELETE_DEPARTMENT, URL_DELETE_LEAVE, URL_DELETE_PROMOTION, URL_DELETE_TIMESHEET } from "@/config/api-paths";
...
// console.log('====================================');
  ...
  const showModal = (value, record) => {
    ...
    if (value == "add") {
      ...
      // setModalTitle(<AddPromotionTitle/>);
      setModalWidth(700);
      setModalContent(<AddPromotion setIsModalVisible={setIsModalVisible} jwt={jwt} refetch={refetch} forceRefetch={forceRefetch} qryEmployeeData={qryEmployeeData} qryAttrData={qryAttrData}/>)
      }
  ...
  const EditPromotionStatusTitle = () => (
    <div className="flex flex-wrap" style={{ width: 700 }}>
      <h6>Edit Promotion Status</h6>
    </div>
  );
  ...
  const EditPromotionTitle = () => (
    <div className="flex flex-wrap" style={{ width: 700 }}>
      <h6>Edit Promotion</h6>
    </div>
  );

  const AddPromotionTitle = () => (
    <div className="flex flex-wrap" style={{ width: 700}}>
    <h6>Add Promotion</h6>
  ...
  const handleDelete = (record) => {
    deleteRequest(URL_DELETE_PROMOTION, record?.promotion_id, jwt)
      .then(async(res) => {
