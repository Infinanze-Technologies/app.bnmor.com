...
import { URL_UPDATE_ALLOWANCE, URL_UPDATE_DEDUCTION, URL_UPDATE_SALARY } from "@/config/api-paths";
...
const EditSaturationDeduction = (props) => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await updateRequest(URL_UPDATE_DEDUCTION, record?.deduction_id, { ...values }, jwt);
  ...
  return (
    <div style={{ padding: '20px' }}>
      <Form onFinish={onFinish} form={form} name="editDeductionForm" size="middle" layout="vertical">
...
export default EditSaturationDeduction;
