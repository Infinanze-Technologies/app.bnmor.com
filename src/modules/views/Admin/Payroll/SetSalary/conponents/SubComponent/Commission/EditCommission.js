...
import { URL_UPDATE_ALLOWANCE, URL_UPDATE_COMMISSION, URL_UPDATE_SALARY } from "@/config/api-paths";
...
const EditCommission = (props) => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await updateRequest(URL_UPDATE_COMMISSION, record?.commission_id, { ...values }, jwt);
  ...
  return (
    <div style={{ padding: '20px' }}>
      <Form onFinish={onFinish} form={form} name="editCommissionForm" size="middle" layout="vertical">
