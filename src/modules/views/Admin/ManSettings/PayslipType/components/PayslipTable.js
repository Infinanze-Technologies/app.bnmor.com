...
import EditPayslipType from "./EditPayslipType";
...
import AddPayslipType from "./AddPayslipType";
...
const PayslipTable = (props) => {
  ...
  const showModal = (value, record) => {
    ...
    if (value == "add") {
      ...
      setModalWidth(500);
      setModalContent(<AddPayslipType setIsModalVisible={setIsModalVisible} jwt={jwt} refetch={refetch} forceRefetch={forceRefetch}/>)
      }
