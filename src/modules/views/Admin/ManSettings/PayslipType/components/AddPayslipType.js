...
const AddPayslipType = (props) => {
  ...
  const onFinish = async (values) => {
    try {
      values['attribute_type'] = "Payslip Type"
  ...
  return (
    <Form
        ...
        layout="vertical"
      >
        <Card type="inner" title="Add Payslip Type" style={{ marginBottom: 24, borderRadius: 8 }}>
      <Row gutter={16}>
          <Col span={24} md={24}>
            <CustomInput
              label="Name"
