...
const AddDeductionOption = (props) => {
  ...
  const onFinish = async (values) => {
    try {
      values['attribute_type'] = "Deduction Option"
  ...
  return (
    <Form
        form={form}
        name="addDeductionOption"
        onFinish={onFinish}
        layout="vertical"
      >
        <Card type="inner" title="Add Deduction Option" style={{ marginBottom: 24, borderRadius: 8 }}>
      <Row gutter={16}>
          <Col span={24} md={24}>
            <CustomInput
              label="Name"
...
export default AddDeductionOption;
