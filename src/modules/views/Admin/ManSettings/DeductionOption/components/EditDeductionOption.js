...
const EditDeductionOption = (props) => {
  ...
  return (
      <Form
        form={form}
        name="editDeductionOption"
        onFinish={onFinish}
        layout="vertical"
      >
        <Card type="inner" title="Edit Deduction Option" style={{ marginBottom: 24, borderRadius: 8 }}>
      <Row gutter={16}>
          <Col span={24} md={24}>
            <CustomInput
              label="Name"
...
export default EditDeductionOption;
