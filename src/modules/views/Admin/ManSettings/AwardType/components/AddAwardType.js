...
const AddAwardType = (props) => {
  ...
  const onFinish = async (values) => {
    try {
      values['attribute_type'] = "Award Type"
  ...
  return (
      ...
      <Form onFinish={onFinish} form={form} name="addAwardType" layout="vertical">
        <Card type="inner" title="Add Award Type" style={{ marginBottom: 24, borderRadius: 8 }}> 
