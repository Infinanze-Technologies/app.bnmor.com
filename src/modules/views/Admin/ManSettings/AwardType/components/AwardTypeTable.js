...
import EditAwardType from "./EditAwardType";
...
import AddAwardType from "./AddAwardType";
import Pagination from "@/hooks/Pagination";
// import Image from "next/image";

const AwardTypeTable = (props) => {
  ...
  const showModal = (value, record) => {
    ...
    if (value == "add") {
      ...
      setModalWidth(500);
      setModalContent(<AddAwardType setIsModalVisible={setIsModalVisible} jwt={jwt} refetch={refetch} forceRefetch={forceRefetch}/>)
      }
