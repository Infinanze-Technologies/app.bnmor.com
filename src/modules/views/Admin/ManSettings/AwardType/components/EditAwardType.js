...
const EditAwardType = (props) => {
  ...
  return (
      <Form onFinish={onFinish} form={form} name="editAwardType" layout="vertical">
        <Card type="inner" title="Edit Award Type" style={{ marginBottom: 24, borderRadius: 8 }}> 
