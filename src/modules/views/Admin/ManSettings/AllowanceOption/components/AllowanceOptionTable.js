...
import EditAllowanceOption from "./EditAllowanceOption";
...
import AddAllowanceOption from "./AddAllowanceOption";
...
const AllowanceOption = (props) => {
  ...
  const showModal = (value, record) => {
    ...
    if (value == "add") {
      ...
      setModalWidth(500);
      setModalContent(<AddAllowanceOption setIsModalVisible={setIsModalVisible} jwt={jwt} refetch={refetch} forceRefetch={forceRefetch}/>)
      }
      ...
      <div className="card-body">
        ...
        <UserTableStyleWrapper>
          ...
          <Table
            ...
            locale={{
              emptyText: qryData?.length === 0 ? 'No data found' : 'No data'
            }}
            rowKey="id"
            style={{
              background: '#ffffff'
