...
const EditAllowanceOption = (props) => {
  ...
  return (
      ...
      <Form onFinish={onFinish} form={form} name="editAllowanceOption" layout="vertical">
        <Card type="inner" title="Edit Allowance Option" style={{ marginBottom: 24, borderRadius: 8 }}> 
      <Row gutter={16}>
          <Col span={24} md={24}>
            <CustomInput
              label="Name"
...
export default EditAllowanceOption;
