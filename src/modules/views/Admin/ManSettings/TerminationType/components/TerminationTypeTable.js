...
const TerminationTypeTable = (props) => {
  ...
  const showModal = (value, record) => {
    ...
    if (value == "add") {
      ...
      setModalWidth(500);
      setModalContent(<AddTerminationType setIsModalVisible={setIsModalVisible} jwt={jwt} refetch={refetch} forceRefetch={forceRefetch}/>)
      }
 ...
 <div className="card card-table flex-fill" style={{ 
        ...
        boxShadow: '0 4px 20px rgba(77, 77, 77, 0.08)'
          ...
          <h3 className="card-title mb-0" style={{ 
            ...
            Man Settings - Termination Types
          </h3>
          <Button 
