...
import { URL_ADD_BORROWER, URL_GET_Qry_BRANCH } from "@/config/api-paths";
...
const AddBorrower = (props) => {
  ...
  const onFinish = async values => {
    ...
    // return;
    setLoading(true);
    postRequest(URL_ADD_BORROWER,{...data},jwt)
    .then(async (res) => {
      setLoading(false);
  ...
  return (
    <div style={{ 
      ...
      <Card
        title={<span style={{ fontSize: 24, fontWeight: 700, color: "#2a3f54" }}>Create New Borrower</span>}
        bordered={false}
