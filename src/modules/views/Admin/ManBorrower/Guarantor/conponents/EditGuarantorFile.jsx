...
import { URL_UPDATE_GUARANTOR_IMAGE } from '@/config/api-paths';

const { Title, Text } = Typography;

const EditGuarantorFile = ({ 
  visible, 
  onCancel, 
  record, 
  fileType, 
  ...
  const handleSubmit = async () => {
    try {
      ...
      await updateRequest(URL_UPDATE_GUARANTOR_IMAGE, record?.files?.file_id, { ...updateData }, jwt).then((res) => {
...
export default EditGuarantorFile;
